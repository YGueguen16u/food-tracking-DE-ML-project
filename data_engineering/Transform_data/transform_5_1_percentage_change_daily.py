...
def main():
    """
    Main function to compute daily percentage changes using both Pandas and DuckDB
    """
    try:
        print("Computing daily percentage changes...")
        ...
        print("Daily percentage changes computed successfully!")
