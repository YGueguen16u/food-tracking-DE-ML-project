...
base_url = "https://stock.adobe.com/fr/search?k="
...
for aliment in aliments:
    ...
    aliment_url = f"{base_url}{aliment}&search_type=usertyped"

    images_downloaded = 0
    page = 1
    while images_downloaded < num_images:
        images_to_download = min(num_images - images_downloaded, 100) # Adobe Stock affiche 100 images par page
